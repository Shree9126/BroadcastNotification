package com.mindnotix.broadcastnoti;
...
public class MainActivity extends AppCompatActivity {
    public static final String ACTION = "com.mindnotix.bcr.noti";
    ...
    public void setalarm() {
        ...
        //---sets the time for the alarm to trigger in 1 minutes from now---
        ...
        notificationIntent.setPackage("com.mindnotix.broadcastnoti"); //in API 26, it must be explicit now.
